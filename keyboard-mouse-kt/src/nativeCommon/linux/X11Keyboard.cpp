...
class X11Keyboard : public KeyboardMouseInternal {
   private:
    void *x11;
    void *xInput2;
    void *xTest;
    ...
    X11Keyboard(void *x11, void *xInput2, void *xTest,
                       Display *display) {
        this->x11 = x11;
    ...
    static void setupDisplayAndReadWhenRequired(std::promise<Display *> &&p) {
        ...
        X11Keyboard *handler;
        while ((handler = getInstance()) == NULL) {
   ...
   public:
    static X11Keyboard *getInstance() {
        static X11Keyboard _instance;
        X11Keyboard *instance = &_instance;
        ...
        instance = new X11Keyboard(x11, xInput2, xTest, display);
